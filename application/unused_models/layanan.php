...
/**
 * Layanan DataMapper Model
 *
 * Use this basic model as a layanan for creating new models.
 * It is not recommended that you include this file with your application,
 * especially if you use a Layanan library (as the classes may collide).
 *
 * To use:
 * 1) Copy this file to the lowercase name of your new model.
 * 2) Find-and-replace (case-sensitive) 'Layanan' with 'Your_model'
 * 3) Find-and-replace (case-sensitive) 'layanan' with 'your_model'
 * 4) Find-and-replace (case-sensitive) 'layanans' with 'your_models'
...
class Layanan extends DataMapper {
	...
	var $has_many = array(
        'course' => array(			// in the code, we will refer to this relation by using the object name 'book'
            ...
            'join_table' => 'layanan_punya_course'),	// name of the join table that will link both Author and Book together
    );
...
/* Location: ./application/models/layanan.php */
