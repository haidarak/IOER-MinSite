...
<li class="header">MAIN NAVIGATION</li>
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url('admin/kelola_layanan'); ?>"><i class="fa fa-circle-o"></i> Kelola Layanan</a></li>
                <li class="active"><a href="<?php echo base_url('admin/kelola_term'); ?>"><i class="fa fa-circle-o"></i> Kelola Term</a></li>
